...
public class Service {
    ...
    public int saveStudent(String id, String name, int group) {
        ...
        //if result is null then it means that the student was not in the list
        if (result == null) {
            return 0;
        }
        //if the result is not null then the student that is in the result is already in the list and we dont add it again
        return 1;
    }
    ...
    public int deleteStudent(String id) {
        ...
        //if the result is null it means that we have not found the student with the given id
        if (result == null) {
            return 1;
        }
        //if the result is not null then the result contains the student which is deleted
        return 0;
    }
